            ...
            <form className="w-full">
                <div className="mb-2">
                    ...
                    <input
                        ...
                        className="block w-full p-[16px] mt-1 rounded-lg outline-none placeholder:text1 placeholder:text-text10 text1 "
                    />
                </div>
                <div className="mb-2">
                    <label
                ...
                <div className="mb-2">
                    ...
                    <select
                        id="department"
                        className="block w-[100%] p-[16px] mt-1 rounded-lg outline-none placeholder:text1 placeholder:text-text10 text1 "
                    >
                ...
                <div className="mb-2">
                    ...
                    <div className="bg- rounded-lg p-2 text-center bg-backgroundColor2  mt-1">
                        <img src={IMAGES.CLIPBOARD} alt={IMAGES.CLIPBOARD} className="w-[39px] mx-auto" />
                        <span className="text2 text-text4 ">
                            Drag file and <span className="font-bold underline" id="files" >Browse</span>
                        </span>
                ...
                <Button title={"Submit to Apply"} type={"submit"} btnStyle={"bg-backgroundColor1 w-full text-backgroundColor2 heading7 rounded-lg "} />
            </form>
        </div>
