...
export default function Meet(props) {
  ...
  return (
    <section className="sm:bg-[#F6F5F5] ">
      <div className="w-[80%] mx-auto md:py-6 my-6 ">
      <h2 className=" text-center mb-6 outfit-font heading6 font-semibold text-[#004671] leading-0">
              {title}
            </h2>
        <div className="z-0 grid grid-cols-12 lg:gap-8 xl:gap-12 lg:mb-6 bg-white border p-4  md:p-8 w-full">
          <div className="col-span-12 lg:col-span-6 flex items-center justify-center relative lg:min-h-[550px] xl:min-h-[650px]">
            <div className="flex-col z-20 justify-center items-center text-center my-4 lg:my-auto">
              <img
                id={`ltr`}
                src={IMAGES.CEO}
                className={`md:w-[400px] md:h-[400px] rounded-md  w-[250px] lg:w-[600px] lg:h-[600px] xl:w-[500px] xl:h-[600px] md:mx-auto my-2 ltr ${visibleCards.includes(`ltr`) ? "visible" : ""} `}
              />
            </div>
          </div>
          <div className="col-span-12 lg:col-span-5 z-20 flex flex-col justify-center">
            ...
            <p className="font-light text1 text-dark text-[#004671] text-justify">
              {des}
            </p>
