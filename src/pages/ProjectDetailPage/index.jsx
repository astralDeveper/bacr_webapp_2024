        ...
        <div className="flex md:flex-row flex-col md:items-start items-center justify-center gap-4 w-full relative">
          ...
          <div className="2xl:w-[40%] w-full px-4">
            ...
            <div className="my-5">
              ...
              <p className="heading7">Part no: <span className="font-semibold">5647</span></p>
              <p className="heading7">Serial no: <span className="font-semibold">5647</span></p>
              <p className="heading7">Capacity: <span className="font-semibold">5647</span></p>
