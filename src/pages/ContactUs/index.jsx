                    ...
                    <div className='flex flex-col gap-6 xl:w-[77%]' >
                        ...
                        <div className='flex items-center lg:gap-6 gap-4 lg:flex-row md:flex-row flex-col'>
                            <div className='flex items-center gap-2'>
                                <img src={IMAGES.PHONE} alt={IMAGES.PHONE} className='md:w-[24px] w-[10px]' />
                                <p className='text1'>+92 345 3456563</p>
                            </div>
                            <div className='flex items-center gap-2'>
                                <img src={IMAGES.MAIL} alt={IMAGES.MAIL} className='md:w-[24px] w-[10px]' />
                                <p className='text1'>bacremail@gmail.com</p>
                            </div>
                        </div>
                    </div>

                    <div className='border w-full md:p-10 p-3 rounded-2xl shadow-shadow2 md:mt-10 mt-6' >
                        <form className='flex items-center flex-col justify-center md:gap-10 gap-4 w-full ' >
                            ...
                            <textarea placeholder='Message (Option)' className='border placeholder:text1 placeholder:text-text8 w-full md:p-6 border-text8 md:h-[170px] h-[120px] rounded-2xl outline-none' autoComplete={false} ></textarea>
