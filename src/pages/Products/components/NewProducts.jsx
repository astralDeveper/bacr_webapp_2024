        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6  ">
          {currentProducts.map((item, ind) => (
            <div
              ...
              // Uncomment the below line if you want click handling functionality
            ...
            >
              ...
              <div className="mt-4">
                <p className="text2">
                  Model No:{" "}
                  <span className="font-bold text2">{item.model}</span>
                </p>
                <p className="text2">
                  Brand Name:{" "}
                  <span className="font-bold text2">{item.brandId.name}</span>
                </p>
              </div>
